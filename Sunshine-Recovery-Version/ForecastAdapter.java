...
public class ForecastAdapter extends CursorAdapter {
    ...
    //Flag to determine if we want a separate view from "today"
    private boolean muUseTodayLayout = true;
    ...
    public int getItemViewType(int position) {
        return (position == 0 && muUseTodayLayout) ? VIEW_TYPE_TODAY : VIEW_TYPE_FUTURE_DAY;
    }
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        // For accessibility, set content a description to the icon view
    ...
    public void setUseTodayLayout(boolean useTodayLayout) {
        muUseTodayLayout = useTodayLayout;
    }
